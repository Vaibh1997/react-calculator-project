...
export const Home_loan = () => {
  ...
  useEffect(() => {
    ...
    console.log("innnnnn" + Total_interest);

    settotalPayment(
      Math.round(amounts + interestPayables).toLocaleString("en-IN")
    );
  }, [amount, interest, tenure, interestPayable, pieData]);
  ...
  return (
    <div className="calculator">
      <h1 className="heading">EMI Calculator for Home Loan</h1>
      ...
      <div
        ...
        style={{ width: "700px", margin: "0px 50px" }}
      >
        <Slider
      ...
      <div className="tenure">
        ...
        <label
          for="yr"
          className={currentTenureSelection === "year" ? "active" : "button"}
        >
          yr
        </label>
        <input
        ...
        <label
          for="mo"
          className={
            currentTenureSelection === "month" ? "active_month" : "button month"
          }
        >
          mo
        </label>
